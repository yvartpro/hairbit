...
const Appointment = sequelize.define('Appointment', {
  ...
  position: { type: DataTypes.INTEGER, allowNull: false, comment: 'Queue position sequence' },
  status: { type: DataTypes.ENUM('WAITING', 'IN_PROGRESS', 'DONE', 'CANCELLED'), defaultValue: 'WAITING' },
